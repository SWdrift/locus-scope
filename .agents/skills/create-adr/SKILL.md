---
name: create-adr
description: "创建和维护面向 agent 编码工作流的 Architecture Decision Records（ADR）。用于提出、撰写、更新、接受/拒绝、废弃或替代 ADR，初始化 ADR 目录和索引，或执行 ADR 约定；起草前通过苏格拉底式提问捕获意图，并按 agent 可执行性清单验证产物。"
---
