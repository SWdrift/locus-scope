...
- [公共协议](protocol/README.md)：汇总用户和工具直接依赖的稳定契约。
  ...
  - [错误契约](protocol/ERRORS.md)：定义 Scope 与 Package application error 的分类、reason、上下文和 transport 映射。
...
- 使用或集成命令行：阅读 [CLI](protocol/CLI.md)；需要程序化错误分类时再阅读[错误契约](protocol/ERRORS.md)。
